...
export default function ReportsRent() {
  ...
  return (
    <>
      <div className="page-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 report-print-hidden">
        <div>
          <h2>تقارير الإيجار</h2>
          <p>إيجارات الكباتن خلال الفترة المحددة</p>
        </div>
        ...
        {loading ? (
          ...
          <>
            <div className="stats-grid report-print-hidden">
              <div className="stat-card"><div className="number">{formatMoney(report.summary.total_rent)}</div><div className="label">إجمالي الإيجار</div></div>
            </div>
